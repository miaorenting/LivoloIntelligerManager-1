...
public class SwitchButton extends View{
    ...
    protected void drawCheckedIndicator(Canvas canvas) {
        drawCheckedIndicator(canvas,
                ...
                checkLineWidth,
                left * 2 + viewRadius - checkedLineOffsetX, centerY - checkLineLength + 2,
                left * 2 + viewRadius - checkedLineOffsetY, centerY + checkLineLength - 2,
                paint);
    }
...
//    }
    ...
    public interface onClickListener {
        void onClickListener(SwitchButton view, boolean isChecked);
    }

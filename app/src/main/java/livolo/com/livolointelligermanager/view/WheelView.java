...
public class WheelView extends ListView {
    ...
    private void init() {
        ...
        mItemLayoutId = R.layout.item_cyclewheel_custom;
        mItemLabelTvId = R.id.tv_label_item_wheel_custom;
     ...
     * 设置滚轮是否为循环滚动
     *
     * @param enable true-循环滚动 false-单程滚动
     */
    ...
    public void setSelection(final int position) {
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                WheelView.super.setSelection(getPosition(position));
            }
        });
    }
